...
|                                                                                                                             |
|                                       +------------------------------------------------------+                                |
|   Internet --------> Internet Gateway |        Public Route Table (RT)                       |                                |
|                                       +------------------------------------------------------+                                |
|                                               |            (Associated with Public Subnets)                               |
|                                               |                                                                             |
|                                               |                                                                             |
|  +--------------------------------------------v-----------------------------------------------------------------------+      |
|  |           Availability Zone 1 (AZ1)          |           Availability Zone 2 (AZ2)           | Availability Zone 3 (AZ3) |      |
|  +----------------------------------------------+-----------------------------------------------+-----------------------+      |
|  | Public Subnet (10.0.0.0/20)                  | Public Subnet (10.0.16.0/20)                  | Public Subnet (10.0.32.0/20)  |      |
|  |   [Proxy/Load Balancer]                      |   [Load Balancer]                             | [Load Balancer]               |      |
|  |    +------------------------+                |                                               |                               |      |
|  |    | ALB / ELB              |                |                                               |                               |      |
|  |    +-----------^------------+                |                                               |                               |      |
|  |                |                             |                                               |                               |      |
...
|                   |                         |                                                                               |
|                   |             +------------------------------------------------------+                                    |
|                   |             |          Private App RT (Routes to NAT Gateway)      |                                    |
|                   |             +------------------------------------------------------+                                    |
|                   |                      |       (Associated with App Subnets)                                              |
|                   |                      |                                                                                  |
|                   |                      |                                                                                  |
|  +----------------|---------------------+---------------------------------------------------------------------------------+      |
|  | Private App Subnet (10.0.48.0/20)    | Private App Subnet (10.0.64.0/20)             | Private App Subnet (10.0.80.0/20) |      |
...
|                                                  |                                                                             |
|                                                  |   +---------------------------------------------+                           |
|                                                  |   |        Private DB RT (Routes to NAT Gateway)  |                           |
|                                                  |   +---------------------------------------------+                           |
|                                                  |       (Associated with DB Subnets)                                          |
|                                                  |                                                                             |
| +------------------------------------------------v-----------------------------------------------------------------------------+
| | Private DB Subnet (10.0.96.0/20)            | Private DB Subnet (10.0.112.0/20)           | Private DB Subnet (10.0.128.0/20) |      |
| |   [RDS/EC2 DB Instance]                       |   [RDS/EC2 DB Instance]                       | [RDS/EC2 DB Instance]           |      |
| |    [DB SG]                                    |    [DB SG]                                    | [DB SG]                         |      |
| +-----------------------------------------------+-----------------------------------------------+-----------------------------+
